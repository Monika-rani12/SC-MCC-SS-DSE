...
printf("POINT: 410\n");
    __CPROVER_input("symb",symb);       
        ...
        // read input
        __CPROVER_input("a1056944550",a1056944550);   
        __CPROVER_input("a778335169",a778335169);   
        __CPROVER_input("a162289881",a162289881);   
        __CPROVER_input("a1663271343",a1663271343);   
        __CPROVER_input("a1518986556",a1518986556);   
        __CPROVER_input("a190474899",a190474899);   
        __CPROVER_input("cf",cf);  
        __CPROVER_input("inputs",inputs);  
