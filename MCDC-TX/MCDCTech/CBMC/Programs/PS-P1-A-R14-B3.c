  ...
  int a188,cf,a70,a109,a131,a191,a168,a130,a57,a13;
...
__CPROVER_input("a109",a109);
__CPROVER_input("a131",a131);
__CPROVER_input("a191",a191);
__CPROVER_input("a168",a168);
__CPROVER_input("a130",a130);
__CPROVER_input("a57",a57);
__CPROVER_input("a13",a13);


printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d",a188,cf,a70,a109,a131,a191,a168,a130,a57,a13);
