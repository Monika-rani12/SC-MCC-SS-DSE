...
#include <stdlib.h>
	...
	void calculate_outputm220(int);
	 ...
	 int a175,a137,a62,a148,a152,a68,a149,a141,a3,a19;
	 
	 int a126,a97,a170,a16,a168,a179,a165,a26,a173,a73;
	 
	 int a55,a161,a114,a69,a188,a65,a41,a49,a196,a11;
	 
	 int a13,a187,a50,a169,cf;
...
__CPROVER_input("a137",a137);  
__CPROVER_input("a62",a62);  
__CPROVER_input("a148",a148);  
__CPROVER_input("a152",a152);  
__CPROVER_input("a68",a68);  
__CPROVER_input("a149",a149);   
__CPROVER_input("a141",a141); 
__CPROVER_input("a3",a3); 
__CPROVER_input("a19",a19);     

__CPROVER_input("a126",a126);  
__CPROVER_input("a97",a97);  
__CPROVER_input("a170",a170);  
__CPROVER_input("a16",a16);  
__CPROVER_input("a168",a168); 
__CPROVER_input("a179",a179);   
__CPROVER_input("a165",a165); 
__CPROVER_input("a26",a26);   
__CPROVER_input("a173",a173); 
__CPROVER_input("a73",a73);  

__CPROVER_input("a55",a55);  
__CPROVER_input("a161",a161);  
__CPROVER_input("a114",a114);  
__CPROVER_input("a69",a69);  
__CPROVER_input("a188",a188);  
__CPROVER_input("a65",a65);  
__CPROVER_input("a41",a41);   
__CPROVER_input("a49",a49); 
__CPROVER_input("a196",a196); 
__CPROVER_input("a11",a11);  

__CPROVER_input("a13",a13);  
__CPROVER_input("a187",a187);  
__CPROVER_input("a50",a50);  
__CPROVER_input("a169",a169);  
__CPROVER_input("cf",cf);  

printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n",a175,a137,a62,a148,a152,a68,a149,a141,a3,a19);	
printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n",a126,a97,a170,a16,a168,a179,a165,a26,a173,a73);
printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n",a55,a161,a114,a69,a188,a65,a41,a49,a196,a11);
printf("%d\n%d\n%d\n%d\n%d\n",a13,a187,a50,a169,cf);
        // operate eca engine
printf("POINT: 801\n");
