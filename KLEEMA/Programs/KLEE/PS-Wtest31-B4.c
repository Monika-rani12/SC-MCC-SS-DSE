...
#include <stdlib.h>
	...
	int a1056944550,a778335169,a162289881,a1663271343,a1518986556,a190474899,cf;
...
printf("POINT: 410\n");
    klee_make_symbolic(&symb, sizeof(int ), "symb");    
        ...
        // read input
        klee_make_symbolic(&a1056944550, sizeof(int ), "a1056944550");   
        klee_make_symbolic(&a778335169, sizeof(int ), "a778335169");   
        klee_make_symbolic(&a162289881, sizeof(int ), "a162289881");   
        klee_make_symbolic(&a1663271343, sizeof(int ), "a1663271343");   
        klee_make_symbolic(&a1518986556, sizeof(int ), "a1518986556");   
        klee_make_symbolic(&a190474899, sizeof(int ), "a190474899");   
        klee_make_symbolic(&cf, sizeof(int ), "cf");   
        printf("%d\n%d\n%d\n%d\n%d\n%d\n%d",a1056944550,a778335169,a162289881,a1663271343,a1518986556,a190474899,cf);   
