...
#include <klee/klee.h>
  ...
  int a1917497990,a1268307040,cf,a33642816,a1354855424,a2135605241,a1033413197;
...
klee_make_symbolic(&a1917497990, sizeof(int ), "a1917497990"); 
klee_make_symbolic(&a1268307040, sizeof(int ), "a1268307040"); 
klee_make_symbolic(&cf, sizeof(int ), "cf"); 
klee_make_symbolic(&a33642816, sizeof(int ), "a33642816"); 
klee_make_symbolic(&a1354855424, sizeof(int ), "a1354855424"); 
klee_make_symbolic(&a2135605241, sizeof(int ), "a2135605241"); 
klee_make_symbolic(&a1033413197, sizeof(int ), "a1033413197"); 

printf("%d\n%d\n%d\n%d\n%d\n%d\n%d",a1917497990,a1268307040,cf,a33642816,a1354855424,a2135605241,a1033413197);
