...
printf("POINT: 1374\n");
      ...
      klee_make_symbolic(&a647992626, sizeof(int ), "a647992626");
      klee_make_symbolic(&a2068151937, sizeof(int ), "a2068151937");
      klee_make_symbolic(&a1163913646, sizeof(int ), "a1163913646");
      klee_make_symbolic(&a175435081, sizeof(int ), "a175435081");
      klee_make_symbolic(&a573660885, sizeof(int ), "a573660885");
      klee_make_symbolic(&a400180708, sizeof(int ), "a400180708");
      klee_make_symbolic(&a1708500674, sizeof(int ), "a1708500674");
      klee_make_symbolic(&a1520738029, sizeof(int ), "a1520738029");
      klee_make_symbolic(&a322699279, sizeof(int ), "a322699279");
      klee_make_symbolic(&a650139459, sizeof(int ), "a650139459");       
        // operate eca engine
printf("POINT: 1375\n");
