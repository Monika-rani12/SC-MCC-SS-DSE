 ...
 #include <klee/klee.h>
  ...
  int a149,a43,a93,a102,a117,cf,a34,a145;
...
klee_make_symbolic(&a93, sizeof(int ), "a93");
klee_make_symbolic(&a102, sizeof(int ), "a102");
klee_make_symbolic(&a117, sizeof(int ), "a117");
klee_make_symbolic(&cf, sizeof(int ), "cf");
klee_make_symbolic(&a34, sizeof(int ), "a34");
klee_make_symbolic(&a145, sizeof(int ), "a145");

printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d",a149,a43,a93,a102,a117,cf,a34,a145);
