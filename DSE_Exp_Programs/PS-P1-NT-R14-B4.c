...
klee_make_symbolic(&a54, sizeof(int ), "a54");
klee_make_symbolic(&a38, sizeof(int ), "a38");
klee_make_symbolic(&a9, sizeof(int ), "a9");
klee_make_symbolic(&a184, sizeof(int ), "a184");
klee_make_symbolic(&cf, sizeof(int ), "cf");
klee_make_symbolic(&a34, sizeof(int ), "a34");
klee_make_symbolic(&a64, sizeof(int ), "a64");
klee_make_symbolic(&a161, sizeof(int ), "a161");
klee_make_symbolic(&a3, sizeof(int ), "a3");
klee_make_symbolic(&a138, sizeof(int ), "a138");
