...
klee_make_symbolic(&a131, sizeof(int ), "a131");
klee_make_symbolic(&a191, sizeof(int ), "a191");
klee_make_symbolic(&a168, sizeof(int ), "a168");
klee_make_symbolic(&a130, sizeof(int ), "a130");
klee_make_symbolic(&a57, sizeof(int ), "a57");
