...
klee_make_symbolic(&a81, sizeof(int ), "a81"); 
klee_make_symbolic(&a158, sizeof(int ), "a158"); 
klee_make_symbolic(&a45, sizeof(int ), "a45"); 
klee_make_symbolic(&a168, sizeof(int ), "a168"); 
klee_make_symbolic(&a100, sizeof(int ), "a100"); 
klee_make_symbolic(&a120, sizeof(int ), "a120"); 
klee_make_symbolic(&a63, sizeof(int ), "a63");      
klee_make_symbolic(&a119, sizeof(int ), "a119"); 
klee_make_symbolic(&a112, sizeof(int ), "a112"); 
