...
klee_make_symbolic(&a351, sizeof(int ), "a351");  
klee_make_symbolic(&a86, sizeof(int ), "a86");  
klee_make_symbolic(&a329, sizeof(int ), "a329");  
klee_make_symbolic(&a154, sizeof(int ), "a154");  
klee_make_symbolic(&a182, sizeof(int ), "a182");  
klee_make_symbolic(&a99, sizeof(int ), "a99");  
klee_make_symbolic(&a286, sizeof(int ), "a286");   
klee_make_symbolic(&a132, sizeof(int ), "a132"); 
klee_make_symbolic(&a282, sizeof(int ), "a282"); 
klee_make_symbolic(&a125, sizeof(int ), "a125"); 
