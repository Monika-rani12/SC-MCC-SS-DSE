...
klee_make_symbolic(&a137, sizeof(int ), "a137");  
klee_make_symbolic(&a62, sizeof(int ), "a62");  
klee_make_symbolic(&a148, sizeof(int ), "a148");  
klee_make_symbolic(&a152, sizeof(int ), "a152");  
klee_make_symbolic(&a68, sizeof(int ), "a68");  
klee_make_symbolic(&a149, sizeof(int ), "a149");   
klee_make_symbolic(&a141, sizeof(int ), "a141"); 
klee_make_symbolic(&a3, sizeof(int ), "a3"); 
klee_make_symbolic(&a19, sizeof(int ), "a19");   

klee_make_symbolic(&a126, sizeof(int ), "a126");  
klee_make_symbolic(&a97, sizeof(int ), "a97");  
klee_make_symbolic(&a170, sizeof(int ), "a170");  
klee_make_symbolic(&a16, sizeof(int ), "a16");  
klee_make_symbolic(&a168, sizeof(int ), "a168"); 
klee_make_symbolic(&a179, sizeof(int ), "a179");   
klee_make_symbolic(&a165, sizeof(int ), "a165"); 
klee_make_symbolic(&a26, sizeof(int ), "a26");   
klee_make_symbolic(&a173, sizeof(int ), "a173"); 
klee_make_symbolic(&a73, sizeof(int ), "a73");  

klee_make_symbolic(&a55, sizeof(int ), "a55");  
klee_make_symbolic(&a161, sizeof(int ), "a161");  
klee_make_symbolic(&a114, sizeof(int ), "a114");  
klee_make_symbolic(&a69, sizeof(int ), "a69");  
klee_make_symbolic(&a188, sizeof(int ), "a188");  
klee_make_symbolic(&a65, sizeof(int ), "a65");  
klee_make_symbolic(&a41, sizeof(int ), "a41");   
klee_make_symbolic(&a49, sizeof(int ), "a49"); 
klee_make_symbolic(&a196, sizeof(int ), "a196"); 
klee_make_symbolic(&a11, sizeof(int ), "a11");  

klee_make_symbolic(&a13, sizeof(int ), "a13");  
klee_make_symbolic(&a187, sizeof(int ), "a187");  
klee_make_symbolic(&a50, sizeof(int ), "a50");  
