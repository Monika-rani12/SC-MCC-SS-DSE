  ...
  int inputs[] = {2,4,3,1,5};
   ...
   int a182,a140,a106,a104,a188,a181,a85,cf,a178,a16;
...
klee_make_symbolic(&a182, sizeof(int ), "a182"); 
klee_make_symbolic(&a140, sizeof(int ), "a140"); 
klee_make_symbolic(&a106, sizeof(int ), "a106"); 
klee_make_symbolic(&a104, sizeof(int ), "a104"); 
klee_make_symbolic(&a188, sizeof(int ), "a188"); 
klee_make_symbolic(&a181, sizeof(int ), "a181"); 
klee_make_symbolic(&a85, sizeof(int ), "a85"); 
klee_make_symbolic(&cf, sizeof(int ), "cf"); 
klee_make_symbolic(&a178, sizeof(int ), "a178"); 
klee_make_symbolic(&a16, sizeof(int ), "a16"); 


printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d",a182,a140,a106,a104,a188,a181,a85,cf,a178,a16);
