...
klee_make_symbolic(&a75, sizeof(int ), "a75");
klee_make_symbolic(&a101, sizeof(int ), "a101");
klee_make_symbolic(&a122, sizeof(int ), "a122");
klee_make_symbolic(&a136, sizeof(int ), "a136");
klee_make_symbolic(&a100, sizeof(int ), "a100");
klee_make_symbolic(&a35, sizeof(int ), "a35");
klee_make_symbolic(&a167, sizeof(int ), "a167");
klee_make_symbolic(&a61, sizeof(int ), "a61");
klee_make_symbolic(&a118, sizeof(int ), "a118");
