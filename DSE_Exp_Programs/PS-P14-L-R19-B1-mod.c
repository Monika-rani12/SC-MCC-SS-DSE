...
printf("POINT: 1556\n");
      ...
      klee_make_symbolic(&a10419264, sizeof(int ), "a10419264");
      klee_make_symbolic(&a179752516, sizeof(int ), "a179752516");
      klee_make_symbolic(&a1736640332, sizeof(int ), "a1736640332");
      klee_make_symbolic(&a1053530639, sizeof(int ), "a1053530639");
      klee_make_symbolic(&a127383885, sizeof(int ), "a127383885");
      klee_make_symbolic(&a286009693, sizeof(int ), "a286009693");
      klee_make_symbolic(&a1837110425, sizeof(int ), "a1837110425");
      klee_make_symbolic(&a565249046, sizeof(int ), "a565249046");
      klee_make_symbolic(&a864013224, sizeof(int ), "a864013224");
      klee_make_symbolic(&a2015844410, sizeof(int ), "a2015844410");       
        // operate eca engine
printf("POINT: 1557\n");
